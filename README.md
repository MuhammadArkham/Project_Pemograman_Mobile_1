...
2. [StoryBoard Project](#2-storyboard-project)
3. [Mockup Project](#3-mockup-project)
4. [UI Project & Color Palette](#4-ui-user-interface-project--color-palette)
5. [Notifikasi Firebase](#5-notifikasi-firebase)
6. [Implementasi Android Studio](#6-implementasi-android-studio)

---

### 1. Splash Screen
*(Fitur: Deteksi lokasi otomatis, penyesuaian bendera negara, dan ucapan "Say Hello/Selamat Datang" berbasis wilayah regional masing-masing pengguna)*

<div align="center">
  <img src="FOTO PROJECT/Splashscreen.png" alt="Splash Screen" width="300">
</div>
...
<div align="center">
  <img src="FOTO PROJECT/Storyboard.png" alt="Storyboard Project" width="800">
</div>

<details>
<summary><b>📐 Klik untuk Melihat Detail Alur Frame Storyboard (01 - 21)</b></summary>
<br>
...
<div align="center">
  <img src="FOTO PROJECT/Mockup.png" alt="Mockup Project" width="800">
</div>
...
<div align="center">
  <img src="FOTO PROJECT/UI.png" alt="UI Project" width="800">
  <br><br>
  <b>🎨 Palet Warna Aplikasi</b><br>
  <img src="FOTO PROJECT/CP.png" alt="Color Palette" width="800">
</div>

<details>
<summary><b>📖 Klik untuk Melihat Keterangan Fungsi Setiap Layar UI (01 - 21)</b></summary>
<br>

* **01. Splash Screen:** Layar pembuka dengan logo identitas FITME saat aplikasi pertama kali dijalankan.
* **02 - 04. Onboarding 1-3:** Pengenalan fitur-fitur unggulan aplikasi kepada pengguna baru, seperti memantau pola makan dan kebiasaan sehat.
* **05. Pilih Peran:** Layar pemilihan jenis kelamin (Laki-laki / Perempuan) yang menjadi dasar penentuan kebutuhan kalori.
* **06. Pilih Tujuan:** Pengguna dapat memilih target spesifik mereka: menurunkan berat badan, menjaga berat badan, atau menambah massa otot.
* **07. Input Data Diri:** Pengisian parameter fisik tubuh seperti Usia, Tinggi Badan, Berat Badan, dan Tingkat Aktivitas Harian.
* **08. Target Kalori:** Menampilkan target kebutuhan makronutrisi harian (Karbohidrat, Protein, Lemak) yang dipersonalisasi berdasarkan data pengguna.
* **09. Tips Harian:** Halaman edukasi yang berisi panduan kesehatan untuk menjaga konsistensi pengguna.
* **10. Login:** Layar masuk dengan form email/password, serta opsi otentikasi menggunakan pihak ketiga.
* **11. Beranda:** Layar utama beranda yang menampilkan ringkasan kalori, menu cepat, dan rekomendasi harian.
* **12. Dashboard:** Layar detail pemantauan kebutuhan kalori harian yang telah dipenuhi beserta asupan nutrisinya.
* **13. Menu Makanan:** Katalog berbagai opsi menu sehat yang dikategorikan berdasarkan preferensi.
* **14. Rekomendasi:** Daftar kurasi makanan sehat dengan tujuan spesifik (contoh: tinggi protein atau rendah kalori).
* **15. Detail Makanan:** Menampilkan informasi gizi lengkap (Karbo, Lemak, Protein) dari sebuah makanan.
* **16. Resep:** Daftar inspirasi resep makanan sehat untuk berbagai waktu makan.
* **17. Detail Resep:** Menyajikan rincian bahan-bahan dan langkah-langkah praktis untuk memasak resep terkait.
* **18. Catatan Harian:** Halaman log makanan tempat pengguna mencatat makanan yang dikonsumsi pada hari tersebut.
* **19. Detail Catatan:** Menampilkan rincian nutrisi yang tercatat pada makanan tertentu yang sudah dimakan.
* **20. Progress:** Pemantauan hasil program pengguna berupa grafik garis yang menggambarkan tren berat badan dari waktu ke waktu.
* **21. Detail Progress:** Laporan rinci dari pencapaian selisih berat badan serta status Indeks Massa Tubuh (BMI) pengguna saat ini.
</details>

---

### 5. Notifikasi Firebase

<div align="center">
  <img src="FOTO PROJECT/Screenshot%202025-12-19%20005452.png" alt="Notifikasi Firebase 1" width="300">&nbsp;&nbsp;&nbsp;&nbsp;
  <img src="FOTO PROJECT/WhatsApp%20Image%202025-12-23%20at%2010.34.15_734c87b3.jpg" alt="Notifikasi Firebase 2" width="300">
</div>

---

### 6. Implementasi Android Studio

Berikut adalah tabel tangkapan layar fungsionalitas utama aplikasi FITME yang telah berhasil diimplementasikan menggunakan kode native Android Studio:

<table align="center">
  <tr>
    <td align="center"><b>Tampilan Splashscreen</b><br><img src="FOTO PROJECT/Screenshot%202026-01-15%20211819.png" width="220"></td>
    <td align="center"><b>Tampilan Home (Dashboard)</b><br><img src="FOTO PROJECT/Screenshot%202026-01-15%20211844.png" width="220"></td>
    <td align="center"><b>Tampilan Gender Selection</b><br><img src="FOTO PROJECT/Screenshot%202026-01-15%20211557.png" width="220"></td>
  </tr>
  <tr>
    <td align="center"><b>Tampilan Input Data</b><br><img src="FOTO PROJECT/Screenshot%202026-01-15%20211751.png" width="220"></td>
    <td align="center"><b>Tampilan Result</b><br><img src="FOTO PROJECT/Screenshot%202026-01-15%20211808.png" width="220"></td>
    <td align="center"><b>Tampilan Riwayat</b><br><img src="FOTO PROJECT/Screenshot%202026-01-15%20211620.png" width="220"></td>
  </tr>
</table>
